  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto hide-scrollbar space-y-6 pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h2 className="text-2xl font-medium text-[#F5F1E8]">Booking Calendar</h2>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-xl px-2 py-1 text-xs text-[#C7C3BA]">
            ...
            <span className="px-3 font-medium text-[#F5F1E8]">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-xl text-xs font-medium bg-[rgba(245,158,11,0.15)] text-[#F59E0B] hover:bg-[rgba(245,158,11,0.25)] border border-[rgba(245,158,11,0.3)] transition-colors cursor-pointer"
          >
            Today
          </button>
        </div>
